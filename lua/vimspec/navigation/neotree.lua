...
M.spec = function()
	return {
		...
		cmd = "Neotree",
		keys = {
			{ "<leader>e", "<cmd>Neotree toggle reveal<cr>", desc = "Toggle Neotree", mode = "n" },
			{ "<leader>sf", "<cmd>Neotree filesystem<cr>", desc = "Filesystem", mode = "n" },
			{ "<leader>sg", "<cmd>Neotree git_status<cr>", desc = "Git Status", mode = "n" },
			{ "<leader>sb", "<cmd>Neotree buffers<cr>", desc = "Buffers", mode = "n" },
			{ "<leader>sd", "<cmd>Neotree diagnostics<cr>", desc = "Diagnostics", mode = "n" },
		},
		dependencies = {
